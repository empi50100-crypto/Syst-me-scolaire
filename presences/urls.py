...
urlpatterns = [
    ...
    path('seances/<int:seance_id>/demarrer/', views.demarrer_seance, name='demarrer_seance'),
    path('seances/<int:seance_id>/terminer/', views.terminer_seance, name='terminer_seance'),
