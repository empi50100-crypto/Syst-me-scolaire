...
from accounts.models import Service, Module, Permission, User
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Services existants
        services_data = [
            {'nom': 'Gestion des élèves', 'code': 'eleves', 'icon': 'bi bi-people', 'ordre': 1},
            {'nom': 'Gestion Académique', 'code': 'academics', 'icon': 'bi bi-building', 'ordre': 2},
            {'nom': 'Espace Enseignant', 'code': 'enseignant', 'icon': 'bi bi-mortarboard', 'ordre': 3},
            {'nom': 'Gestion des Présences', 'code': 'presences', 'icon': 'bi bi-clipboard-check', 'ordre': 4},
            ...
            {'nom': 'Ressources Humaines', 'code': 'rh', 'icon': 'bi bi-person-badge', 'ordre': 7},
            {'nom': 'Rapports', 'code': 'rapports', 'icon': 'bi bi-file-earmark-bar-graph', 'ordre': 8},
            {'nom': 'Paramètres', 'code': 'parametres', 'icon': 'bi bi-gear', 'ordre': 9},
            {'nom': 'Administration', 'code': 'administration', 'icon': 'bi bi-gear', 'ordre': 10},
        ]
        ...
        modules_data = [
            # Gestion des élèves
            {'service': 'eleves', 'nom': 'Élèves', 'code': 'eleve_list', 'url': '/eleves/', 'icon': 'bi bi-person-badge', 'ordre': 1},
            {'service': 'eleves', 'nom': 'Discipline', 'code': 'discipline', 'url': '/eleves/discipline/', 'icon': 'bi bi-shield-exclamation', 'ordre': 2},
            {'service': 'eleves', 'nom': 'Clôture Périodes', 'code': 'periode_cloture', 'url': '/eleves/periodes/cloture/', 'icon': 'bi bi-lock', 'ordre': 3},
            {'service': 'eleves', 'nom': 'Notes & Périodes', 'code': 'note_cloture', 'url': '/eleves/notes/cloture/', 'icon': 'bi bi-journal-check', 'ordre': 4},
            {'service': 'eleves', 'nom': 'Fiches de Notes', 'code': 'fiche_notes', 'url': '/academics/fiches-notes/', 'icon': 'bi bi-file-text', 'ordre': 5},
            {'service': 'eleves', 'nom': 'Bulletins', 'code': 'bulletins', 'url': '/rapports/bulletins/', 'icon': 'bi bi-journal', 'ordre': 6},
            {'service': 'eleves', 'nom': 'Dossiers médicaux', 'code': 'dossiers_medicaux', 'url': '/eleves/dossiers-medicaux/', 'icon': 'bi bi-heart-pulse', 'ordre': 7},
            {'service': 'eleves', 'nom': 'Documents', 'code': 'documents_eleve', 'url': '/eleves/documents/', 'icon': 'bi bi-file-earmark', 'ordre': 8},
            ...
            {'service': 'presences', 'nom': 'Présence', 'code': 'presence_list', 'url': '/presences/', 'icon': 'bi bi-check-circle', 'ordre': 1},
            ...
            # Communication
            {'service': 'communication', 'nom': 'Notifications', 'code': 'notifications', 'url': '/accounts/notifications/', 'icon': 'bi bi-bell', 'ordre': 1},
            {'service': 'communication', 'nom': 'Messages', 'code': 'messages', 'url': '/accounts/messages/', 'icon': 'bi bi-chat-dots', 'ordre': 2},
            ...
            {'service': 'finances', 'nom': 'Salaires', 'code': 'salaires', 'url': '/finances/salaires/', 'icon': 'bi bi-person-badge', 'ordre': 4},
            {'service': 'finances', 'nom': 'Caisse', 'code': 'caisse', 'url': '/finances/caisse/', 'icon': 'bi bi-safe2', 'ordre': 5},
            {'service': 'finances', 'nom': 'Charges', 'code': 'charges', 'url': '/finances/charges/', 'icon': 'bi bi-cart', 'ordre': 6},
            {'service': 'finances', 'nom': 'Personnel', 'code': 'personnel', 'url': '/finances/personnel/', 'icon': 'bi bi-people', 'ordre': 7},
            {'service': 'finances', 'nom': 'Cycles', 'code': 'cycles', 'url': '/finances/cycles/', 'icon': 'bi bi-calendar-range', 'ordre': 8},
            {'service': 'finances', 'nom': 'Eleves en Retard', 'code': 'eleves_retard', 'url': '/finances/eleves-en-retard/', 'icon': 'bi bi-exclamation-diamond', 'ordre': 9},
            {'service': 'finances', 'nom': 'Factures', 'code': 'factures', 'url': '/finances/factures/', 'icon': 'bi bi-file-earmark-text', 'ordre': 10},
            {'service': 'finances', 'nom': 'Bourses', 'code': 'bourses', 'url': '/finances/bourses/', 'icon': 'bi bi-graduation-cap', 'ordre': 11},
            {'service': 'finances', 'nom': 'Rapports Financiers', 'code': 'rapport_financier', 'url': '/finances/rapport-financier/', 'icon': 'bi bi-graph-up', 'ordre': 12},
            {'service': 'finances', 'nom': 'Rappels', 'code': 'rappels', 'url': '/finances/rappels/', 'icon': 'bi bi-bell-fill', 'ordre': 13},
            
            # Administration - Modules pour la gestion administrative
            {'service': 'administration', 'nom': 'Années scolaires', 'code': 'annee_scolaire', 'url': '/finances/annees/', 'icon': 'bi bi-calendar-event', 'ordre': 1},
            {'service': 'administration', 'nom': 'Utilisateurs', 'code': 'user_list', 'url': '/accounts/users/', 'icon': 'bi bi-person-badge', 'ordre': 2},
            {'service': 'administration', 'nom': 'Comptes bloqués', 'code': 'comptes_bloques', 'url': '/accounts/comptes-bloques/', 'icon': 'bi bi-lock-fill', 'ordre': 3},
            {'service': 'administration', 'nom': 'Gestion Permissions', 'code': 'permissions_utilisateur', 'url': '/accounts/permissions-utilisateur/', 'icon': 'bi bi-shield-lock', 'ordre': 4},
            {'service': 'administration', 'nom': 'Demandes Permissions', 'code': 'demandes_permissions', 'url': '/accounts/permissions-modifications/', 'icon': 'bi bi-file-diff', 'ordre': 5},
            {'service': 'administration', 'nom': 'Admin Django', 'code': 'admin_django', 'url': '/admin/', 'icon': 'bi bi-hdd', 'ordre': 6},
            {'service': 'administration', 'nom': 'Rapports', 'code': 'rapport_academique', 'url': '/rapports/academique/', 'icon': 'bi bi-bar-chart', 'ordre': 7},
            {'service': 'administration', 'nom': 'Approbations', 'code': 'approbations', 'url': '/accounts/demandes/', 'icon': 'bi bi-shield-check', 'ordre': 8},
        ]
