...
from .models import Eleve, EleveInscription, ParentTuteur, DossierMedical, DocumentEleve, SanctionRecompense, ConfigurationConduite, ConduiteEleve
...
@admin.register(ConfigurationConduite)
class ConfigurationConduiteAdmin(admin.ModelAdmin):
...
@admin.register(EleveInscription)
class EleveInscriptionAdmin(admin.ModelAdmin):
