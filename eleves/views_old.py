...
def eleve_list(request):
    ...
    return render(request, 'eleves/eleve_detail.html', {'eleve': eleve, 'inscriptions': inscriptions})
...
def parent_create_view(request):
    ...
    return render(request, 'eleves/parent_form.html', {'eleve': eleve, 'eleves': eleves})
...
def dossiers_medicaux_view(request):
    ...
    return render(request, 'eleves/dossiers_medical.html', {
...
def dossiers_medicaux_view(request):
    ...
    return render(request, 'eleves/dossier_medical_form.html', {'eleve': eleve, 'dossier': dossier})
...
def documents_eleve_view(request):
    ...
    if request.user.is_superadmin() or request.user.is_direction():
        ...
        return redirect('eleves:eleve_detail', pk=eleve_pk)
...
def discipline_list(request):
        ...
        if not is_hierarchie:
            ...
            for user in services:
                ...
                Notification.creer_notification(
                    ...
                    message=message,
                    expediteur=request.user,
                    lien=f'/eleves/discipline/{discipline.pk}/'
                )
    ...
    return render(request, 'eleves/discipline_form.html', {
        'eleves': eleves,
        'can_add': request.user.is_professeur() or request.user.is_surveillance() or request.user.is_direction() or request.user.is_superadmin()
    })
...
def discipline_list(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('eleves:discipline_detail', pk=pk)
...
def discipline_list(request):
    ...
    return render(request, 'eleves/discipline_detail.html', {
...
def discipline_list(request):
    ...
    return render(request, 'eleves/discipline_delete.html', {
        'discipline': discipline
    })
...
@login_required
def view_func(request):
    from academics.models import Classe, Enseignement
    ...
    if request.method == 'POST':
        ...
        return redirect('eleves:periode_cloture_edit', classe_id)
    ...
    return render(request, 'eleves/periode_cloture_form.html', {
        'classe': classe,
        'clotures': clotures,
...
@login_required
def view_func(request):
    from academics.models import Classe, Enseignement, Matiere
    ...
    if request.method == 'POST':
        ...
        return redirect('eleves:note_cloture_edit', classe_id)
    ...
    return render(request, 'eleves/note_cloture_form.html', {
        'classe': classe,
        'clotures': clotures,
